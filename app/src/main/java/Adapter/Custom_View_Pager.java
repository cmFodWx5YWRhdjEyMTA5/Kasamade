 ...
 */
public class Custom_View_Pager extends PagerAdapter {
    ...
    public Custom_View_Pager(final Context context,Activity act, ArrayList<Bean_Master> array_bean) {
        this.ctx = context;
        this.act=act;
                ...
                do {
                  ...
                  /*  System.out.println("Id Stored- " + c.getString(0));
                    ...
                    System.out.println(c.getString(1).equals(String.valueOf(value)));
                     if (c.getString(1).equals(String.valueOf(value))) {
                        //  isPressed = true;
...
*/
     ...
     /* if(array_bean.get(position).getNews_type().equalsIgnoreCase("null")||array_bean.get(position).getNews_type().equalsIgnoreCase("")) {
        ...
        if (array_bean.get(position).getNews_type().equals("2")) {
                youtube_icon.setVisibility(View.VISIBLE);

try {
    String[] key = array_bean.get(position).getImage_url().split("=");
    Picasso.with(act).load("http://img.youtube.com/vi/" + key[0] + "/hqdefault.jpg")
            .fit()
            ...
            public void onClick(View v) {
                ...
                else
                {
                    if (array_bean.get(position).getNews_type().equalsIgnoreCase("2")) {
                        ...
                        i.putExtra("vurl", array_bean.get(position).getImage_url());

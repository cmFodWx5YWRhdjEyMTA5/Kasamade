 ...
 */
public class WeatherRecyclerViewAdapter3 extends RecyclerView.Adapter<WeatherRecyclerViewHolder> {
    ...
    public WeatherRecyclerViewAdapter3(final Context context, List<Climate> itemList, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(final WeatherRecyclerViewHolder recyclerViewHolder, final int position) {
        ...
        recyclerViewHolder.cityField.setText("नाशिक हवामान");

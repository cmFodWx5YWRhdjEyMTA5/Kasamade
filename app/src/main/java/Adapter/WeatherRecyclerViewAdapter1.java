 ...
 */
public class WeatherRecyclerViewAdapter1 extends RecyclerView.Adapter<WeatherRecyclerViewHolder> {
    ...
    public WeatherRecyclerViewAdapter1(final Context context, List<Climate> itemList, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(final WeatherRecyclerViewHolder recyclerViewHolder, final int position) {
        ...
        recyclerViewHolder.cityField.setText("पुणे हवामान");

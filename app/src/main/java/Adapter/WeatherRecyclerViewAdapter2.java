 ...
 */
public class WeatherRecyclerViewAdapter2 extends RecyclerView.Adapter<WeatherRecyclerViewHolder> {
    ...
    public WeatherRecyclerViewAdapter2(final Context context, List<Climate> itemList, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(final WeatherRecyclerViewHolder recyclerViewHolder, final int position) {
        ...
        recyclerViewHolder.cityField.setText("नागपुर हवामान");

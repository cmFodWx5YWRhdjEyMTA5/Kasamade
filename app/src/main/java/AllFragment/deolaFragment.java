...
import Adapter.WeatherRecyclerViewAdapter3;
...
public class deolaFragment extends Fragment {
    ...
    private static WeatherRecyclerViewAdapter3 adapter;
    private Sys sys;
    private Main main;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_deola, container, false);
        ...
        adapter = new WeatherRecyclerViewAdapter3(getActivity().getApplicationContext(), climate, recyclerView);
...
*/
    ...
    private void updateWeatherData(final String q, final String units, final String APPID, final boolean afterCreate) {
        ...
        api.getWeather3(new Callback<Climate>() {
            @Override
    ...
    private void getWeatherFromPrefs() {
        ...
        weather.setId(Splash_Screen_Activity.initialization.getInt("weather_id1", 800));
        sys.setSunrise(Splash_Screen_Activity.initialization.getLong("sunrise1", 0));
        sys.setSunset(Splash_Screen_Activity.initialization.getLong("sunset1", 0));
        main.setHumidity(Splash_Screen_Activity.initialization.getString("humidity1", null));
        main.setPressure(Splash_Screen_Activity.initialization.getString("pressure1", null));
        main.setTemp((double) Splash_Screen_Activity.initialization.getFloat("temparature1", 0));
        climate.setDt(Splash_Screen_Activity.initialization.getLong("updatedOn1", 0));
    ...
    private void setWeatherPrefs(Climate climate) {
        Splash_Screen_Activity.editor.putInt("weather_id1", climate.getWeather().get(0).getId());
        Splash_Screen_Activity.editor.putString("humidity1", climate.getMain().getHumidity());
        Splash_Screen_Activity.editor.putString("pressure1", climate.getMain().getPressure());
        Splash_Screen_Activity.editor.putFloat("temparature1", climate.getMain().getTemp().floatValue());

        //DateFormat df = DateFormat.getDateTimeInstance();
        // String updatedOn = df.format(new Date(climate.getDt() * 1000));
        Splash_Screen_Activity.editor.putLong("updatedOn1", climate.getDt());
        Splash_Screen_Activity.editor.putLong("sunrise1", climate.getSys().getSunrise() * 1000);
        Splash_Screen_Activity.editor.putLong("sunset1", climate.getSys().getSunset() * 1000);

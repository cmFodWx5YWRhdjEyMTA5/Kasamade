 ...
 * {@link malegoanprecaution.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link malegoanprecaution#newInstance} factory method to
 * create an instance of this fragment.
 */
public class malegoanprecaution extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment malegoanprecaution.
     */
    // TODO: Rename and change types and number of parameters
    public static malegoanprecaution newInstance(String param1, String param2) {
        malegoanprecaution fragment = new malegoanprecaution();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_malegoanprecaution, container,false);
        ...
        return rootView;
      //  return inflater.inflate(R.layout.fragment_malegoanprecaution, container, false);
    }
       ...
       /* AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(this, R.style.AlertDialogCustom));
        ...
        switch (id) {
            case R.id.ivGramContOne:
                callNumber("02554258908");
                break;
            case R.id.ivGramContTwo:
                callNumber("100");
                break;
            case R.id.ivWaterOne:
                callNumber("02554233555");
                break;

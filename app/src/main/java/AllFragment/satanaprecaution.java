 ...
 * {@link satanaprecaution.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link satanaprecaution#newInstance} factory method to
 * create an instance of this fragment.
 */
public class satanaprecaution extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment satanaprecaution.
     */
    // TODO: Rename and change types and number of parameters
    public static satanaprecaution newInstance(String param1, String param2) {
        satanaprecaution fragment = new satanaprecaution();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_satanaprecaution, container,false);
        ...
        return rootView;
       // return inflater.inflate(R.layout.fragment_satanaprecaution, container, false);
    }
       ...
       /* AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(this, R.style.AlertDialogCustom));
        ...
        switch (id) {
            case R.id.ivGramContOne:
                callNumber("0255223033");
                break;
            case R.id.ivGramContTwo:
                callNumber("100");
                break;
            case R.id.ivWaterOne:
                callNumber("02555223077");
                break;

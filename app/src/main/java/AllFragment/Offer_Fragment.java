 ...
 * {@link Offer_Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Offer_Fragment#newInstance} factory method to
...
public class Offer_Fragment extends Fragment {
     ...
     * @return A new instance of fragment Offer_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Offer_Fragment newInstance(String param1, String param2) {
        Offer_Fragment fragment = new Offer_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_producer_, container, false);
        ...
        if(Config.isConnectingToInternet(getActivity().getApplicationContext())==true)
        {
            ...
            api.getAllOffer(params, new Callback<List<MessageDetail>>() {
                @Override

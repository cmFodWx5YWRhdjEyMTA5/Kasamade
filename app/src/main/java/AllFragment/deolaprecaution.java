 ...
 * {@link deolaprecaution.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link deolaprecaution#newInstance} factory method to
 * create an instance of this fragment.
 */
public class deolaprecaution extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment deolaprecaution.
     */
    // TODO: Rename and change types and number of parameters
    public static deolaprecaution newInstance(String param1, String param2) {
        deolaprecaution fragment = new deolaprecaution();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_deolaprecaution, container,false);
       ...
       /* AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(this, R.style.AlertDialogCustom));
        ...
        switch (id) {
            case R.id.ivGramContOne:
                callNumber("02592228233");
                break;
            case R.id.ivGramContTwo:
                callNumber("100");
                break;
            case R.id.ivWaterOne:
                 callNumber("02592228209");
                 break;

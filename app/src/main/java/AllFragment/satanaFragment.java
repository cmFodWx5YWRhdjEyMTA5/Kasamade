...
import Adapter.WeatherRecyclerViewAdapter1;
...
public class satanaFragment extends Fragment {
  ...
  //  public static MenuItem item;
    ...
    private static WeatherRecyclerViewAdapter1 adapter;
    private Sys sys;
    private Main main;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_satana, container, false);
        ...
        adapter = new WeatherRecyclerViewAdapter1(getActivity().getApplicationContext(), climate, recyclerView);
...
*/
    ...
    private void updateWeatherData(final String q, final String units, final String APPID, final boolean afterCreate) {
        ...
        api.getWeather1(new Callback<Climate>() {
            @Override
    ...
    private void getWeatherFromPrefs() {
        ...
        weather.setId(Splash_Screen_Activity.initialization.getInt("weather_id2", 800));
        sys.setSunrise(Splash_Screen_Activity.initialization.getLong("sunrise2", 0));
        sys.setSunset(Splash_Screen_Activity.initialization.getLong("sunset2", 0));
        main.setHumidity(Splash_Screen_Activity.initialization.getString("humidity2", null));
        main.setPressure(Splash_Screen_Activity.initialization.getString("pressure2", null));
        main.setTemp((double) Splash_Screen_Activity.initialization.getFloat("temparature2", 0));
        climate.setDt(Splash_Screen_Activity.initialization.getLong("updatedOn2", 0));
    ...
    private void setWeatherPrefs(Climate climate) {
        Splash_Screen_Activity.editor.putInt("weather_id2", climate.getWeather().get(0).getId());
        Splash_Screen_Activity.editor.putString("humidity2", climate.getMain().getHumidity());
        Splash_Screen_Activity.editor.putString("pressure2", climate.getMain().getPressure());
        Splash_Screen_Activity.editor.putFloat("temparature2", climate.getMain().getTemp().floatValue());

        //DateFormat df = DateFormat.getDateTimeInstance();
        // String updatedOn = df.format(new Date(climate.getDt() * 1000));
        Splash_Screen_Activity.editor.putLong("updatedOn2", climate.getDt());
        Splash_Screen_Activity.editor.putLong("sunrise2", climate.getSys().getSunrise() * 1000);
        Splash_Screen_Activity.editor.putLong("sunset2", climate.getSys().getSunset() * 1000);

...
import Adapter.WeatherRecyclerViewAdapter;
...
public class KalavanFragment extends Fragment {
    ...
    private static WeatherRecyclerViewAdapter adapter;
    private Sys sys;
    private Main main;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new WeatherRecyclerViewAdapter(getActivity().getApplicationContext(), climate, recyclerView);
...
*/
    ...
    private void getWeatherFromPrefs() {
        ...
        weather.setId(Splash_Screen_Activity.initialization.getInt("weather_id", 800));
        sys.setSunrise(Splash_Screen_Activity.initialization.getLong("sunrise", 0));
        sys.setSunset(Splash_Screen_Activity.initialization.getLong("sunset", 0));
        main.setHumidity(Splash_Screen_Activity.initialization.getString("humidity", null));
        main.setPressure(Splash_Screen_Activity.initialization.getString("pressure", null));
        main.setTemp((double) Splash_Screen_Activity.initialization.getFloat("temparature", 0));
        climate.setDt(Splash_Screen_Activity.initialization.getLong("updatedOn", 0));
    ...
    private void setWeatherPrefs(Climate climate) {
        Splash_Screen_Activity.editor.putInt("weather_id", climate.getWeather().get(0).getId());
        Splash_Screen_Activity.editor.putString("humidity", climate.getMain().getHumidity());
        Splash_Screen_Activity.editor.putString("pressure", climate.getMain().getPressure());
       float temprature= climate.getMain().getTemp().floatValue()/10;
        Splash_Screen_Activity.editor.putFloat("temparature",temprature);

        //DateFormat df = DateFormat.getDateTimeInstance();
        // String updatedOn = df.format(new Date(climate.getDt() * 1000));
        Splash_Screen_Activity.editor.putLong("updatedOn", climate.getDt());
        Splash_Screen_Activity.editor.putLong("sunrise", climate.getSys().getSunrise() * 1000);
        Splash_Screen_Activity.editor.putLong("sunset", climate.getSys().getSunset() * 1000);
